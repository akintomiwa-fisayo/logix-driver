...
import {
  Modal, View, StyleSheet, Text, Dimensions, LayoutAnimation,
} from 'react-native';
...
const styles = StyleSheet.create({
  ...
  buttonStyle: {
    elevation: 0, bottom: 15, width: '80%', alignSelf: 'center', borderRadius: 20, borderColor: 'transparent', backgroundColor: colors.GREY.btnPrimary,
  },
  buttonContainer: { flex: 1, justifyContent: 'center' },
  inputContainer: { flex: 3, justifyContent: 'center' },
  headerContainer: {
    height: 250, backgroundColor: '#fff', width: '80%', justifyContent: 'space-evenly',
  },
  headerStyle: {
    flex: 1, flexDirection: 'column', backgroundColor: colors.GREY.default, justifyContent: 'center',
  },
  forgotPassText: {
    textAlign: 'center', color: '#fff', fontSize: 20, width: '100%',
  },
