                        ...
                        <View style={styles.myViewStyle}>
                            <View style={styles.iconViewStyle}>
                                <Icon
                                    ...
                                    color={colors.GREY.btnPrimary}
                                />
                                <Text style={styles.emailStyle}>{languageJSON.bank}</Text>
                            </View>
                            <View style={{ flex: 1 }} >
                        ...
                        <View style={styles.myViewStyle}>
                            <View style={styles.iconViewStyle}>
                                <Icon
                                    ...
                                    color={colors.GREY.btnPrimary}
                                />
                                <Text style={styles.emailStyle}>{languageJSON.account_number}</Text>
                            </View>
                            <View style={{ flex: 1 }} >
                                <Text style={styles.text2}>{bank && bank.accountNumber || ""}</Text>
                            </View>
                        </View>
